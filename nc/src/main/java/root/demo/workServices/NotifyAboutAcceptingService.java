...
@Service
public class NotifyAboutAcceptingService implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		System.out.println("CESTITAMO SI GA DS  : : " + nesto);
		SimpleMailMessage message1 = new SimpleMailMessage();
		message1.setTo(nr.getAutor().getEmail());
		message1.setSubject("Obavestenje o prohvatanju rada");
		message1.setText("Vas rad je prihvacen.");
