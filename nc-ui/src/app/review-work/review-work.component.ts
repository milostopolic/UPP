...
@Component({
  selector: 'app-review-work',
  templateUrl: './review-work.component.html',
  styleUrls: ['./review-work.component.css']
})
export class ReviewWorkComponent implements OnInit {
  ...
  onSubmit(value, form) {
    ...
    console.log(o);
    let x = this.workService.postYourReview(o, this.formFieldsDto.taskId);
